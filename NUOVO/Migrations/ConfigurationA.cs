    ...
    internal sealed class ConfigurationA : DbMigrationsConfiguration<NUOVO.DAL.Context>
    {
        ...
        protected override void Seed(NUOVO.DAL.Context context)
        {
            ...
            try
            {
                ...
                {
                    new CommessaRischio{ NomeRischio="Pandemia", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Cablaggio" ).CommessaID , Progressivo=1, DataRilevamento=DateTime.Parse("2015-05-26"), DataAggiornamento=DateTime.Parse("2015-05-27"), Voto=2, Priorita=5, Importo = 12.5f, Probabilita="Rare", Impatto="Catastrophic", Strategia="Contain" },
                    new CommessaRischio{  NomeRischio="Dimissioni", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Abbattimento" ).CommessaID , Progressivo=2, DataRilevamento=DateTime.Parse("2018-06-13"), DataAggiornamento=DateTime.Parse("2018-06-14"), Voto=3, Priorita=1, Importo = 107.35f, Probabilita="Possible", Impatto="Major", Strategia="Transfer" },
                    new CommessaRischio{  NomeRischio="Pandemia operai", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Chemistry" ).CommessaID , Progressivo=3, DataRilevamento=DateTime.Parse("2020-10-18"), DataAggiornamento=DateTime.Parse("2020-10-19"), Voto=4, Priorita=3, Importo = 1273.44f, Probabilita="Almost certain", Impatto="Minor", Strategia="Avoid" },
                    new CommessaRischio{  NomeRischio="Licenziamento", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Cablaggio" ).CommessaID , Progressivo=4, DataRilevamento=DateTime.Parse("2012-05-01"), DataAggiornamento=DateTime.Parse("2012-05-02"), Voto=1, Priorita=4, Importo = 7.99f, Probabilita="Likely", Impatto="Insignificant", Strategia="Transfer" },
                    new CommessaRischio{  NomeRischio="Attacco Hacker", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Abbattimento" ).CommessaID , Progressivo=5, DataRilevamento=DateTime.Parse("2015-11-22"), DataAggiornamento=DateTime.Parse("2016-12-05"), Voto=5, Priorita=2, Importo = 37.45f, Probabilita="Unlikely", Impatto="Moderate", Strategia="Contain" },
                    new CommessaRischio{  NomeRischio="Malattia infettiva", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Chemistry" ).CommessaID , Progressivo=6, DataRilevamento=DateTime.Parse("1999-11-07"), DataAggiornamento=DateTime.Parse("1999-11-08"), Voto=2, Priorita=1, Importo = 199.99f, Probabilita="Rare", Impatto="Catastrophic", Strategia="Avoid" },
                    new CommessaRischio{  NomeRischio="Ricovero", CommessaID=commessa.FirstOrDefault(c => c.Descrizione == "Cablaggio" ).CommessaID , Progressivo=7, DataRilevamento=DateTime.Parse("2008-02-02"), DataAggiornamento=DateTime.Parse("2008-02-03"), Voto=3, Priorita=2, Importo = 0.75f, Probabilita="Possible", Impatto="Major", Strategia="Transfer" }
                };
